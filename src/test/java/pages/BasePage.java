...
//    }
    ...
    public WebElement waitUntilVisible(WebElement element){
        return new WebDriverWait(getDriver(), Duration.ofSeconds(4)).until(ExpectedConditions.visibilityOf(element));
    }

    public WebElement waitUntilClickable(WebElement element){
        return new WebDriverWait(getDriver(), Duration.ofSeconds(4)).until(ExpectedConditions.elementToBeClickable(element));
    }
...
//                return driver = new ChromeDriver(options);
    ...
    public WebDriver lambdaTest() throws MalformedURLException {
        String username = "anna.stonaieva";
        String authkey = "Z0NI2YubxdIrU26MdVgdC8C8c2LX9Z2fyXFifOK6wDDBRUFOyh";
